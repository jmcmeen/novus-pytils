...
from novus_pytils.files.supported_files import (
...
class TestBasicFileOperations:
    ...
    @patch('novus_pytils.files.supported_files._get_handler')
...
class TestBatchOperations:
    ...
    @patch('novus_pytils.files.supported_files.get_file_info')
    @patch('novus_pytils.files.supported_files._get_handler')
