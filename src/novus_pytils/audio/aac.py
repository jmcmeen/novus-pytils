...
def aac_to_wav(aac_file, wav_file):
...
def aac_to_m4a(aac_file, m4a_file):
...
def aac_to_flac(aac_file, flac_file):
...
def aac_to_wma(aac_file, wma_file):
...
def aac_to_ogg(aac_file, ogg_file):
...
def acc_to_acc(aac_file, aac_file_out, bitrate="192k"):
